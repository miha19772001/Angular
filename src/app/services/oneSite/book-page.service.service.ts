...
export class BookService {
  ...
  private aPIKey: string = 'AIzaSyCAcdMYgcpg3NCVMfMJvm3brvI9nBZ6Uf8';
  ...
  public searchBook(nameBook: string) {
    ...
    return this.http.get(`https://www.googleapis.com/books/v1/volumes?q=${nameBook}&key=${this.aPIKey}`, { headers: headers })
